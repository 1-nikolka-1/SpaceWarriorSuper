...
public class Level2 extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        runTimer();
        GameViewLevel2 gm2 =findViewById(R.id.gameViewLevel2);
        ...
        enemy = (ImageView) findViewById(R.id.enemy_mega);
...
//float
        ...
        ch.post(new Runnable() {
            @Override
            public void run() {
                if(GameViewLevel2.endd()==true && winn2==false){
                    qwew();
                }
                ...
                if ((gun1_1_layoutparams.leftMargin>=enemy_layoutParams.leftMargin&& gun1_1_layoutparams.leftMargin<=enemy_layoutParams.leftMargin+180&& time-time1>timeinfle1&& chek1)||
                    ...
                    if(pb1.getProgress()==0 && GameViewLevel2.endd()==false && winn2==false){
                        winn2=true;
                        try{
                            Intent intent=new Intent( Level2.this,EndGameWindow.class);
    ...
    public void qwew(){
        if(enddddddd){
            ...
            winn2=true;
            try{
                Intent intent=new Intent( Level2.this,EndGameWindow_Lose.class);
                startActivity(intent);finish();//end();
            }
            catch (Exception e){
                Log.i("rerewqe","erooooor");}
